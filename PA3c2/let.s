...
movl %eax, %r13d 
                        movq %r13, -24(%rbp)
          ## Storing result of t$2 to self[3]
          movq -24(%rbp), %r14
          movq %r14, 24(%r12)
          movq %r12, %r13
          ## return address handling
...
main_l38_end:            ## end of if conditional
                        movq %r13, -304(%rbp)
                        ## if t$37 jump to main_l4
                        movq -304(%rbp), %r13
                        movq 24(%r13), %r13
                        cmpq $0, %r13
                        jne main_l4
                        ## Basic block: BB8
                        ## if t$36 jump to main_l3
                        movq -296(%rbp), %r13
                        movq 24(%r13), %r13
                        cmpq $0, %r13
                        jne main_l3
...
main_l41_end:            ## end of if conditional
                        movq %r13, -360(%rbp)
                        ## if t$44 jump to main_l7
                        movq -360(%rbp), %r13
                        movq 24(%r13), %r13
                        cmpq $0, %r13
                        jne main_l7
                        ## Basic block: BB15
                        ## if t$43 jump to main_l6
                        movq -352(%rbp), %r13
                        movq 24(%r13), %r13
                        cmpq $0, %r13
                        jne main_l6
...
main_l44_end:            ## end of if conditional
                        movq %r13, -416(%rbp)
                        ## if t$51 jump to main_l10
                        movq -416(%rbp), %r13
                        movq 24(%r13), %r13
                        cmpq $0, %r13
                        jne main_l10
                        ## Basic block: BB22
                        ## if t$50 jump to main_l9
                        movq -408(%rbp), %r13
                        movq 24(%r13), %r13
                        cmpq $0, %r13
                        jne main_l9
...
movl %eax, %r13d 
           ...
           movl $0, %edi
           call exit
.global main_l45_div_ok
main_l45_div_ok:        ## division is okay 
                        movq -480(%rbp), %r14
movq $0, %rdx
movq %r14, %rax
cdq
...
.globl string14
string14:			  # "ERROR: 17: Exception: division by zero\n"
.byte 69	# 'E'
.byte 82	# 'R'
.byte 82	# 'R'
.byte 79	# 'O'
