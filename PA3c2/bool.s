...
Main..new:              ## constructor for Main
			...
			## store class tag, object size and vtable pointer
                        ...
                        popq %rbp
                        movq %r13, 48(%r12)
                        ## self[3] istrue initializer <- not false = 4 < 7 = 5 <= 5 = not true
                        ## new Bool t$0 <- false
                        pushq %rbp
                        pushq %r12
                        movq $Bool..new, %r14
...
init_l12_true:
                        ...
                        popq %rbp
.globl init_l14_end
init_l14_end:            ## end of if conditional
                        movq %r13, -152(%rbp)
                        movq 24(%r13), %r14
                        movq %r14, -160(%rbp)
                        ## t$10 <- t$7 == t$9
...
init_l15_true:
                        ...
                        popq %rbp
.globl init_l17_end
init_l17_end:            ## end of if conditional
                        movq %r13, -200(%rbp)
                        movq 24(%r13), %r14
                        movq %r14, -208(%rbp)
                        ## Boxing result from t$12 and storing to self[3]
                        movq -208(%rbp), %r14
                        ## new Bool
                        pushq %rbp
                        pushq %r12
                        ...
                        movq %r14, 24(%r13)
                        movq %r13, 24(%r12)
                        ## self[4] here initializer <- not not true
                        ## new Bool t$0 <- true
                        pushq %rbp
                        pushq %r12
                        movq $Bool..new, %r14
...
init_l21_true:
                        ...
                        popq %rbp
.globl init_l23_end
init_l23_end:            ## end of if conditional
                        movq %r13, -40(%rbp)
                        movq 24(%r13), %r14
                        movq %r14, -48(%rbp)
                       ...
                       movq %r13, -16(%rbp)
                        ...
                        addq %r14, %r13
                        movq %r13, -48(%rbp)
                        ## Boxing result from t$2 and storing to self[6]
                        movq -48(%rbp), %r14
                        ## new Int
                        pushq %rbp
                        pushq %r12
...
main_l11_end:            ## end of if conditional
                        ...
                        movq 24(%r13), %r14
                        movq %r14, -80(%rbp)
                        ## if t$4 jump to main_l1
                        movq -72(%rbp), %r13
                        movq 24(%r13), %r13
                        cmpq $0, %r13
                        jne main_l1
                        ## Basic block: BB1
                        ## if t$3 jump to main_l0
                        movq -56(%rbp), %r13
                        movq 24(%r13), %r13
                        cmpq $0, %r13
                        jne main_l0
