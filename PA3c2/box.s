...
Main..new:              ## constructor for Main
			...
			## store class tag, object size and vtable pointer
                        ...
                        addq %r14, %r13
                        movq %r13, -48(%rbp)
                        ## Boxing result from t$2 and storing to self[3]
                        movq -48(%rbp), %r14
                        ## new Int
                        pushq %rbp
                        pushq %r12
...
init_l0_div_ok:        ## division is okay 
           ...
           movq %rax, %r13
                       ...
                       movq %r13, -96(%rbp)
                        ...
                        subq %r14, %r13
                        movq %r13, -112(%rbp)
                        ## Boxing result from t$6 and storing to self[4]
                        movq -112(%rbp), %r14
                        ## new Int
                        pushq %rbp
                        pushq %r12
...
.globl string9
string9:			  # "ERROR: 3: Exception: division by zero\n"
.byte 69	# 'E'
.byte 82	# 'R'
.byte 82	# 'R'
.byte 79	# 'O'
