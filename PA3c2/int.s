...
Main_main_0_div_ok:        ## division is okay 
           ...
           movl $0, %edi
           call exit
.global Main_main_1_div_ok
Main_main_1_div_ok:        ## division is okay 
                        movq -272(%rbp), %r14
           movq $0, %rdx
           movq %r14, %rax
           cdq
           ...
           movq %rax, %r13
                       ...
                       movq 24(%r13), %r13
                       movq %r13, -16(%rbp)
                        ## new String t$24 <- " Enter a number\n"
                        pushq %rbp
                        pushq %r12
                        movq $String..new, %r14
                        call *%r14
...
.globl string12
string12:			  # "ERROR: 7: Exception: division by zero\n"
.byte 69	# 'E'
.byte 82	# 'R'
.byte 82	# 'R'
.byte 79	# 'O'
...
.globl string13
string13:			  # "ERROR: 8: Exception: division by zero\n"
.byte 69	# 'E'
.byte 82	# 'R'
.byte 82	# 'R'
.byte 79	# 'O'
