...
Bool..vtable:           ## virtual function table for Bool
                        ...
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl Child..vtable
Child..vtable:          ## virtual function table for Child
                        .quad string2
                        .quad Child..new
                        .quad Object.abort
                        .quad Object.copy
...
Object..vtable:         ## virtual function table for Object
                        ...
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl Parent..vtable
Parent..vtable:         ## virtual function table for Parent
                        .quad string7
                        .quad Parent..new
                        .quad Object.abort
                        .quad Object.copy
...
Bool..new:              ## constructor for Bool
			...
			movq %rax, %r12
                        ...
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl Child..new
Child..new:             ## constructor for Child
                        pushq %rbp
                        movq %rsp, %rbp
                        ## stack room for temporaries: 2
                        movq $16, %r14
...
Object..new:            ## constructor for Object
			...
			movq %rax, %r12
                        ...
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl Parent..new
Parent..new:            ## constructor for Parent
                        pushq %rbp
                        movq %rsp, %rbp
                        ## stack room for temporaries: 2
                        movq $16, %r14
...
.globl l3
l3:                     pushq %r13
                        ## obtain vtable for class Parent
                        movq $Parent..vtable, %r14
                        ## look up f() at offset 5 in vtable
                        movq 40(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
.globl string10
string10:               # "ERROR: 11: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
