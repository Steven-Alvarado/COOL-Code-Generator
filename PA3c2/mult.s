...
Main..new:              ## constructor for Main
			...
			## store class tag, object size and vtable pointer
                        ...
                        movq -8(%rbp), %r13
                        movq %r13, 32(%r12)
                        ## self[5] y initializer <- x * 4 / x + 4 * x / 2
                       ## t$0 <- x
                       movq 32(%r12), %r13
                       movq %r13, -8(%rbp)
                       movq 24(%r13), %r13
           ...
           movl $0, %edi
           call exit
.global Main_init_1_div_ok
Main_init_1_div_ok:        ## division is okay 
                        movq -48(%rbp), %r14
           movq $0, %rdx
           movq %r14, %rax
           cdq
           ...
           movl $0, %edi
           call exit
.global Main_init_2_div_ok
Main_init_2_div_ok:        ## division is okay 
                        movq -128(%rbp), %r14
           movq $0, %rdx
           movq %r14, %rax
           cdq
           ...
           movq %rax, %r13
                        ...
                        addq %r14, %r13
                        movq %r13, -176(%rbp)
                        ## Boxing result from t$10 and storing to self[5]
                        movq -176(%rbp), %r14
                        ## new Int
                        pushq %rbp
                        pushq %r12
...
.globl string10
string10:			  # "ERROR: 8: Exception: division by zero\n"
.byte 69	# 'E'
.byte 82	# 'R'
.byte 82	# 'R'
.byte 79	# 'O'
...
.globl string11
string11:			  # "ERROR: 4: Exception: division by zero\n"
.byte 69	# 'E'
.byte 82	# 'R'
.byte 82	# 'R'
.byte 79	# 'O'
