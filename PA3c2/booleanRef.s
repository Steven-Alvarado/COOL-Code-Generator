...
Main..new:              ## constructor for Main
			...
			movq %rax, %r12
                        ...
                        popq %rbp
                        movq %r13, 24(%r12)
                        ## self[4] holds field isFalse (Bool)
                        ## new Bool
                        pushq %rbp
                        pushq %r12
                        movq $Bool..new, %r14
                        ...
                        popq %rbp
                        movq %r13, 48(%r12)
                        ## self[3] isTrue initializer <- 5 < 10
                        pushq %r12
                        pushq %rbp
                        ## new Int
                        pushq %rbp
                        ...
                        popq %r12
                        movq %r13, 24(%r12)
                        ## self[4] isFalse initializer <- 15 < 5
                        pushq %r12
                        pushq %rbp
                        ## new Int
                        pushq %rbp
...
.globl string8
string8:                # "ERROR: 20: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
