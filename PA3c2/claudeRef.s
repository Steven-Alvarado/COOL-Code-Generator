...
Main.main:              ## method definition
                        ...
                        popq %rbp
                        movq %r13, -64(%rbp)
                        ## fp[-9] holds local input_str (String)
                        ## new String
                        pushq %rbp
                        pushq %r12
                        movq $String..new, %r14
                        ...
                        movq %r15, 24(%r13)
                        movq %r13, -72(%rbp)
                        ## fp[-10] holds local output_str (String)
                        ## new String
                        pushq %rbp
                        pushq %r12
                        movq $String..new, %r14
...
l16:                    ## false branch
                        ...
                        popq %r12
                        popq %rbp
                        ## string19 holds "x is greater than 20..."
                        movq $string19, %r14
                        movq %r14, 24(%r13)
                        pushq %r13
                        pushq %r12
...
l15:                    ## true branch
                        ...
                        popq %r12
                        popq %rbp
                        ## string20 holds "x is between 10 and ..."
                        movq $string20, %r14
                        movq %r14, 24(%r13)
                        pushq %r13
                        pushq %r12
...
l19:                    ## false branch
                        ...
                        popq %r12
                        popq %rbp
                        ## string21 holds "x is between 5 and 9..."
                        movq $string21, %r14
                        movq %r14, 24(%r13)
                        pushq %r13
                        pushq %r12
...
l18:                    ## true branch
                        ...
                        popq %r12
                        popq %rbp
                        ## string22 holds "x is less than 5\n"
                        movq $string22, %r14
                        movq %r14, 24(%r13)
                        pushq %r13
                        pushq %r12
...
l31:                    ## false branch
                        ...
                        popq %r12
                        popq %rbp
                        ## string29 holds "bool1 and bool3 are ..."
                        movq $string29, %r14
                        movq %r14, 24(%r13)
                        pushq %r13
                        pushq %r12
...
l30:                    ## true branch
                        ...
                        popq %r12
                        popq %rbp
                        ## string30 holds "bool1 is false but b..."
                        movq $string30, %r14
                        movq %r14, 24(%r13)
                        pushq %r13
                        pushq %r12
...
l34:                    ## false branch
                        ...
                        popq %r12
                        popq %rbp
                        ## string31 holds "bool1 is true but bo..."
                        movq $string31, %r14
                        movq %r14, 24(%r13)
                        pushq %r13
                        pushq %r12
...
l33:                    ## true branch
                        ...
                        popq %r12
                        popq %rbp
                        ## string32 holds "Both bool1 and bool2..."
                        movq $string32, %r14
                        movq %r14, 24(%r13)
                        pushq %r13
                        pushq %r12
...
.globl string20
string20:               # "x is between 10 and 20\\n"
.byte 120 # 'x'
.byte  32 # ' '
.byte 105 # 'i'
.byte 115 # 's'
...
.globl string29
string29:               # "bool1 and bool3 are both false\\n"
.byte  98 # 'b'
.byte 111 # 'o'
.byte 111 # 'o'
.byte 108 # 'l'
...
.globl string30
string30:               # "bool1 is false but bool3 is true\\n"
.byte  98 # 'b'
.byte 111 # 'o'
.byte 111 # 'o'
.byte 108 # 'l'
...
.globl string31
string31:               # "bool1 is true but bool2 is false\\n"
.byte  98 # 'b'
.byte 111 # 'o'
.byte 111 # 'o'
.byte 108 # 'l'
...
.globl string32
string32:               # "Both bool1 and bool2 are true\\n"
.byte  66 # 'B'
.byte 111 # 'o'
.byte 116 # 't'
.byte 104 # 'h'
