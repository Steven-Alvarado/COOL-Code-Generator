...
init_l18_end:            ## end of if conditional
                        ...
                        movq 24(%r13), %r14
                        movq %r14, -80(%rbp)
                        ## Boxing result from t$4 and storing to self[4]
                        movq -80(%rbp), %r14
                        ## new Bool
                        pushq %rbp
                        pushq %r12
...
movl %eax, %r13d 
                       ...
                       movq 24(%r13), %r13
                       movq %r13, -16(%rbp)
                        ## new String t$35 <- "Enter a number\n"
                        pushq %rbp
                        pushq %r12
                        movq $String..new, %r14
                        call *%r14
...
.globl string14
string14:			  # "ERROR: 8: Exception: division by zero\n"
.byte 69	# 'E'
.byte 82	# 'R'
.byte 82	# 'R'
.byte 79	# 'O'
...
.globl string15
string15:			  # "ERROR: 9: Exception: division by zero\n"
.byte 69	# 'E'
.byte 82	# 'R'
.byte 82	# 'R'
.byte 79	# 'O'
