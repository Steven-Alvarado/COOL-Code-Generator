...
Main..new:          ## constructor for Main
          ...
          movq -8(%rbp), %r14
          movq %r14, 24(%r12)
          ## self[4] b initializer <- not not 4 < 4
                        ## new int t$0 <- 4
                        pushq %rbp
                        pushq %r12
                        movq $Int..new, %r14
...
init_l7_true:
                        ...
                        movq %r14, 24(%r13)
.globl init_l9_end
init_l9_end:            ## end of if conditional
                        movq %r13, -32(%rbp)
                        ## t$4 <- not t$3
                        movq -32(%rbp), %r13
                        movq 24(%r13), %r13
...
init_l10_true:
                        ...
                        movq %r14, 24(%r13)
.globl init_l12_end
init_l12_end:            ## end of if conditional
                        movq %r13, -40(%rbp)
          ## Storing result of t$4 to self[4]
          movq -40(%rbp), %r14
          movq %r14, 32(%r12)
          movq %r12, %r13
          ## return address handling
...
.globl string9
string9:			  # "ERROR: 5: Exception: division by zero\n"
.byte 69	# 'E'
.byte 82	# 'R'
.byte 82	# 'R'
.byte 79	# 'O'
