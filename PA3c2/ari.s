...
Main..new:              ## constructor for Main
			...
			## store class tag, object size and vtable pointer
                        ...
                        movq -8(%rbp), %r13
                        movq %r13, 24(%r12)
                        ## self[4] y initializer <- 43 * 4 / x + 2 - 4345
                        ## new int t$0 <- 43
                        pushq %rbp
                        pushq %r12
                        movq $Int..new, %r14
...
movq %rax, %r13
                        ...
                        subq %r14, %r13
                        movq %r13, -144(%rbp)
                        ## Boxing result from t$8 and storing to self[4]
                        movq -144(%rbp), %r14
                        ## new Int
                        pushq %rbp
                        pushq %r12
...
.globl string10
string10:			  # "ERROR: 3: Exception: division by zero\n"
.byte 69	# 'E'
.byte 82	# 'R'
.byte 82	# 'R'
.byte 79	# 'O'
