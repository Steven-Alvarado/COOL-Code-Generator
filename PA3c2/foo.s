...
Foo..new:          ## constructor for Foo
          ...
          ## self[4] y initializer <- x + 1
                        ...
                        addq %r14, %r13
                        movq %r13, -24(%rbp)
          ## Storing result of t$2 to self[4]
          movq -24(%rbp), %r14
          movq %r14, 32(%r12)
...
movq %rax, %r13
                        movq %r13, -24(%rbp)
          ## Storing result of t$2 to self[5]
          movq -24(%rbp), %r14
          movq %r14, 40(%r12)
          movq %r12, %r13
          ## return address handling
...
movq %rax, %r13
          ...
          ## self[6] a initializer <- z
                        ...
                        movq 40(%r12), %r13
                        movq %r13, -8(%rbp)
          ## Storing result of t$0 to self[6]
          movq -8(%rbp), %r14
          movq %r14, 48(%r12)
          movq %r12, %r13
          ## return address handling
...
.globl string12
string12:			  # "ERROR: 4: Exception: division by zero\n"
.byte 69	# 'E'
.byte 82	# 'R'
.byte 82	# 'R'
.byte 79	# 'O'
