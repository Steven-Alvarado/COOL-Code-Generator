...
Main..new:              ## constructor for Main
			...
			## store class tag, object size and vtable pointer
                        ...
                        popq %rbp
                        movq %r13, 40(%r12)
                        ## self[6] holds field a (Object)
                        movq $0, %r13
                        movq %r13, 48(%r12)
                        ## self[7] holds field b (IO)
                        movq $0, %r13
                        movq %r13, 56(%r12)
                        ## self[8] holds field q (String)
                        ## new String
                        pushq %rbp
                        pushq %r12
                        movq $String..new, %r14
                        ...
                        popq %rbp
                        movq %r13, 80(%r12)
                        ## self[11] holds field r (Object)
                        movq $0, %r13
                        movq %r13, 88(%r12)
                        ## self[12] holds field s (Int)
                        ## new Int
                        pushq %rbp
                        pushq %r12
                        movq $Int..new, %r14
                        ...
                        ## self[6] a initializer -- none
                        ## self[7] b initializer -- none
                        ## self[8] q initializer <- "initialized\n"
                        ## new String t$0 <- "initialized\n"
                        pushq %rbp
                        pushq %r12
                        movq $String..new, %r14
                        call *%r14
                        popq %r12
                        popq %rbp
                        ## string7 holds "initialized\n"
                        movq $string7, %r14
                        movq %r14, 24(%r13)
                        movq %r13, -8(%rbp)
                        movq -8(%rbp), %r13
                        movq %r13, 64(%r12)
                        ## self[9] w initializer <- 4 * 4
                        ## new int t$0 <- 4
                        pushq %rbp
                        pushq %r12
                        movq $Int..new, %r14
            ...
            imulq %r14, %r13
                        movq %r13, -48(%rbp)
                        ## Boxing result from t$2 and storing to self[9]
                        movq -48(%rbp), %r14
                        ## new Int
                        pushq %rbp
                        pushq %r12
            ...
            imulq %r14, %r13
                        movq %r13, -48(%rbp)
                        ## Boxing result from t$2 and storing to self[12]
                        movq -48(%rbp), %r14
                        ## new Int
                        pushq %rbp
                        pushq %r12
