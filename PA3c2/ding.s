...
Main..new:          ## constructor for Main
          ...
          movq %r14, 16(%r12)
                        ...
                        popq %rbp
                        movq %r13, 48(%r12)
          ## self[3] y initializer <- not false
                        ## new Bool t$0 <- false
                        pushq %rbp
                        pushq %r12
                        movq $Bool..new, %r14
...
init_l14_end:            ## end of if conditional
                        movq %r13, -16(%rbp)
          ## Storing result of t$1 to self[3]
          movq -16(%rbp), %r14
          movq %r14, 24(%r12)
          ## self[4] x initializer <- not true
                        ## new Bool t$0 <- true
                        pushq %rbp
                        pushq %r12
                        movq $Bool..new, %r14
...
init_l17_end:            ## end of if conditional
                        movq %r13, -16(%rbp)
          ## Storing result of t$1 to self[4]
          movq -16(%rbp), %r14
          movq %r14, 32(%r12)
...
main_l11_end:            ## end of if conditional
                        movq %r13, -64(%rbp)
                        ## if t$7 jump to main_l1
                        movq -64(%rbp), %r13
                        movq 24(%r13), %r13
                        cmpq $0, %r13
                        jne main_l1
                        ## Basic block: BB1
                        ## if t$6 jump to main_l0
                        movq -56(%rbp), %r13
                        movq 24(%r13), %r13
                        cmpq $0, %r13
                        jne main_l0
