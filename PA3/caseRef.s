...
l7:                     ## case expression ends
			...
			je l8
                        movq %r13, -8(%rbp)
                        movq 0(%r13), %r13
                        ## case Bool will jump to l9
                        ## case Object will jump to l10
                        ## case expression: compare type tags
                        movq $0, %r14
                        cmpq %r14, %r13
			je l9
			...
			je l10
.globl l11
l11:                    ## case expression: error case
                        movq $string11, %r13
                        ## guarantee 16-byte alignment before call
			andq $0xFFFFFFFFFFFFFFF0, %rsp
			movq %r13, %rdi
...
l10:                    ## fp[-1] holds case o (Object)
                        ...
                        jmp l12
.globl l12
l12:                    ## case expression ends
                        ## fp[0] holds local s (Object)
                        ## new String
                        pushq %rbp
                        pushq %r12
                        movq $String..new, %r14
...
l16:                    ## case expression: void case
			...
			call exit
                        ## case expression: branches
.globl l17
l17:                    ## fp[-1] holds case str (String)
                        ## out_string(...)
                        pushq %r12
                        pushq %rbp
                        ## str
                        ...
                        jmp l20
.globl l18
l18:                    ## fp[-1] holds case obj (Object)
                        ## out_string(...)
                        pushq %r12
                        pushq %rbp
                        ## new String
...
.globl string11
string11:               # "ERROR: 13: Exception: case without matching branch\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string12
string12:               # "ERROR: 13: Exception: case on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string17
string17:               # "ERROR: 20: Exception: case without matching branch\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string18
string18:               # "ERROR: 20: Exception: case on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
