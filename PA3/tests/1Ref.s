...
Bool..vtable:           ## virtual function table for Bool
                        ...
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl Factorial..vtable
Factorial..vtable:      ## virtual function table for Factorial
                        .quad string2
                        .quad Factorial..new
                        .quad Object.abort
                        .quad Object.copy
...
Bool..new:              ## constructor for Bool
			...
			movq %rax, %r12
                        ...
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl Factorial..new
Factorial..new:         ## constructor for Factorial
                        pushq %rbp
                        movq %rsp, %rbp
                        ## stack room for temporaries: 2
                        movq $16, %r14
...
Object.type_name.end:   ## method body ends
                        ...
                        ret
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl Factorial.fact
Factorial.fact:         ## method definition
                        pushq %rbp
                        movq %rsp, %rbp
                        movq 16(%rbp), %r12
...
l4:                     ## false branch
			...
			movq %rax, %r13
                        ...
                        pushq %r13
                        pushq %r12
                        ## obtain vtable for self object of type Factorial
                        movq 16(%r12), %r14
                        ## look up fact() at offset 5 in vtable
                        movq 40(%r14), %r14
                        call *%r14
                        addq $16, %rsp
                        popq %rbp
...
.globl Factorial.fact.end
Factorial.fact.end:     ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
...
.globl l6
l6:                     pushq %r13
                        ## obtain vtable from object in r1 with static type Factorial
                        movq 16(%r13), %r14
                        ## look up fact() at offset 5 in vtable
                        movq 40(%r14), %r14
                        call *%r14
