...
IO.out_string.end:      ## method body ends
                        ...
                        ret
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl Main.factorial
Main.factorial:         ## method definition
                        pushq %rbp
                        movq %rsp, %rbp
                        movq 16(%rbp), %r12
...
l4:                     ## false branch
			...
			movq %rax, %r13
                        ...
                        movq 16(%r12), %r14
                        ## look up factorial() at offset 5 in vtable
                        movq 40(%r14), %r14
                        call *%r14
                        addq $16, %rsp
                        popq %rbp
...
.globl Main.factorial.end
Main.factorial.end:     ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
...
.globl string9
string9:                # "ERROR: 8: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string10
string10:               # "ERROR: 9: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
